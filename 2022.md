...
## Common ground, reason skepticism 

The 2012 book "In Praise of Reason" by Michael P. Lynch for MIT Press (see review [here](https://ndpr.nd.edu/reviews/in-praise-of-reason/)) is interesting for thinking about the common ground. After all, one would expect "reason" to be part of the common ground. And yet, what counts as "reason" -- say what counts as fact, evidence, good reasoning (deductive, inductive) or a good method of rational inquiry -- is contested. So, not even reason is an uncontroversial common ground. 

For Lynch, the key challenge to be confronted here seems skepticism: there is no non-circular way to defend the reliability and trusthworthiness of a method of rational inquiry. Chapter 3 "Nothing but Dreams and Smoke" is very good. My worry though is that skepticim might not be the challange we are confronting today when we see the breakdown of public reason or polarization. It is an interetsing conjecture to think that the problem ultimately lies with skepticism, but it might be overkill. Slepticism has always been with us. The question is, why now?

Lynch gives a non-epistemic, pragmatic argument for why we should prefer methods of inquiry that are transparent, subject to public scrutiny, corrigibile, etc. He gives a Rawls style argument: people would agree that these methods should be selected over others. These methods are close to those of science. This discussion is in Chapter 5 "The Sacred Tradition of Humanity".  Lynch insists this is a pragmatic argument, not an epistemic one, which would be circular. At the same time, he mentions another arguemnt that such science-like methods are more truth-conducive. If correct, I'd find this latter argument more persuasive. For it is unclear to me how a non-epistemic argument can give (good) reasons for following a method whose key purpose is to deliver epistemic goods. If it turned out that science-like methods delivered falsehoods more often than competing methods -- while still having a pragmatic argument in their favor -- would it still be rational to follow them? Presumably not. What work is the pragmatic argument doing?

An aside: I wonder if a simulation-based arguement could work. Say we can show that method M1 is more likey to get at the truth than method M2, and we repeat the simulation several times or we prove the claim analytically. The skeptic could still say that we do not know whether the similation will translate into reality, but we will gain some evidence that M1 is better than M2. 
...
(RWL)[Economic Sanctions: Too Much of a Bad Thing](https://www.brookings.edu/research/economic-sanctions-too-much-of-a-bad-thing/)

## Shannon's Theory of communication

Perhpas a mathematical theory of communication assumes stable rules for coding/decoding messages---and this is all that communication does. So the common ground is pureluy rule-baed, procedural with computational constraints---something Davidson obvjects to human communication (see discussion below "Davidons on meaning, comon ground and conventions")

- (RWL)[Recent Advances in Computer Science Topic: Science of Information](https://cs.brynmawr.edu/Courses/cs380/fall2012/)

See in particular, the slides on Shannon theory of communication.

- (RWL)[What is Information Theory](https://shannon.engr.tamu.edu/front-page/)

- Video [interview](https://www.youtube.com/watch?v=Rfdbk663L0I) with Robert Fano, inventors of the Shannon-Fano coding. 


## Common Ground  and Davidson's Radical Interpretation

From the SEP [article](https://plato.stanford.edu/entries/davidson/#RadiInte) on Davidson:

>  "The basic problem that **radical interpretation** must address is that one cannot assign meanings to a speaker’s utterances without knowing what the speaker believes, while one cannot identify beliefs without knowing what the speaker’s utterances mean. It seems that we must provide both a theory of belief and a theory of meaning at one and the same time. Davidson claims that the way to achieve this is through the application of the so-called ‘principle of charity’ (Davidson has also referred to it as the principle of ‘rational accommodation’) a version of which is also to be found in Quine."

>  "If we assume that the speaker’s beliefs, at least in the simplest and most basic cases, are largely in agreement with our own, and so, by our account, are largely true, then we can use our own beliefs about the world as a guide to the speaker’s beliefs. And, provided that we can identify simple assertoric utterances on the part of a speaker (that is, provided we can identify the attitude of holding true), then the interconnection between belief and meaning enables us to use our beliefs as a guide to the meanings of the speaker’s utterances – we get the basis for both a rudimentary theory of belief and a rudimentary account of meaning."

Here we see that in order to carry out the task of radical interpretation, we need to assume that what others believe is roughly correspondent to what we believe and then we use tha assumption to understand what they mean.

What about caes of **ordinary interpretation** -- say cases in which we do speak the same language but we also do not completely. Maybe we are unsure about what the other person means by certian words. We are also tryign to figure out what the other person mean. So here again,  we can probably use both dimension to carry out the tastk of intepretation. We can assume sameness of meaning and use that to figure out what one believes, or we can assume sameness of beliefs and use taht to figure what one means. The interplay of these two "shared grounds" (sameness of meaning or sameness of belief) seem key to have meaningful communication. 

# October 2


## Davidson on meaning, common ground and conventions

- Davidson, [A Nice Derangement of Epitaphs](http://www.sfs.uni-tuebingen.de/~mramscar/papers/Davidson_Derangement.pdf)

Nice [handout](https://jeelooliu.net/375%20(8)%20Davidson_A%20Nice%20Derangement%20(handout).pdf) available. The following three principles seem sensible

>  "(1) **First meaning is systematic**. A competent speaker or interpreter is able to
interpret utterances, his own or those of others, on the basis of the
semantic properties of the parts, or words, in the utterance, and the
structure of the utterance. For this to be possible, there must be systematic
relations between the meanings of utterances."

>  "(2) **First meanings are shared**. For speaker and interpreter to communicate
successfully and regularly, they must share a method of interpretation of
the sort described in (1)."

>   "(3) **First meanings are governed by learned conventions or regularities**. The
systematic knowledge or competence of the speaker or interpreter is
learned in advance of occasions of interpretation and is conventional in
character."

Davidson shows that they are not so obvious. He writes in the end:
...
What does that mean? A SEP article on Davison explains:

>  "Understanding a language is a matter of continually adjusting interpretative presuppositions (presuppositions that are often not explicit) in accord with the utterances to be interpreted. Furthermore, this calls upon skills and knowledge (imagination, attentiveness to the attitudes and behaviour of others, knowledge of the world) that are not specifically linguistic and that are part of a more general ability to get on in the world and in relation to others – an ability that also resists any formal explication." 
>  
>  "the essential point is that linguistic conventions (and in particular linguistic conventions that take the form of agreement over the employment of shared syntactic and semantic rules), while they may well facilitate understanding, cannot be the basis for such understanding."

So if we are thinking of mutual linguistic understanding as abiding by a set of mechanical, repeatble and stable shared "translation rules" (maybe just like Searle's Chinese room), we would be mistaken. This is interesting, but does not undermine the claim that understdaing requires a common ground of some kind (see later on Radical Translation). That common ground might not made up of mechincal translation rules, but it should still be there somehow.
...
In general (and perhaps simpifying a bit), the difficulty with Davidson's 
theory of meaning is  summzied in thi SEP [article](https://plato.stanford.edu/entries/davidson/#TarsConvT):

>    "There is, however, another more general problem that affects Davidson’s appropriation of Tarski. While Tarski uses the notion of sameness of meaning, through the notion of translation, as the means to provide a definition of truth – one of the requirements of Convention T is that the sentence on the right hand side of a Tarskian T-sentence be a translation of the sentence on the left – Davidson aims to use truth to provide an account of meaning. But in that case it seems that he needs some other way to constrain the formation of T-sentences so as to ensure that they do indeed deliver correct specifications of what sentences mean. "


That's interesting. Yes, Tarski T-sentences are such that 's' and its translation in the meta-language have the same meaning (say, the same truth conditions or whatever). So sameness of meaning drives the construction of T-sentences. But that cannot be so for Davidson's T-theorems since these are supposed to give a (non-circular) theory of meaning and thus cannot presupose sameness of meaning as a constraint on how to formulate them. Soames' objections seem all to stem from this basic point. 
