...
Here the output is 4 (not 2!), because the method bla essentially assigns 4 to b after 2 has been assigned to b, and thus the program prints 4. And that assignments to b is not forgotten.
